          ...
          <RevealBlock key={p.name} delay={i * 0.12}>
            <Link href={p.href} className="group block">
              <div className="relative aspect-[3/4] overflow-hidden rounded-md border border-line bg-porcelain">
                {/* portrait placeholder — client photos drop in here */}
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                  <span className="font-display text-[7rem] font-[380] italic text-line md:text-[10rem]">
                    {p.name.charAt(0)}
                  </span>
                ...
                <span className="absolute bottom-4 right-4 font-mono text-[0.625rem] uppercase tracking-[0.22em] text-stone transition-colors group-hover:text-ultra">
                  Read their story →
                </span>
              </div>
